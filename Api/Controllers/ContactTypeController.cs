...
namespace Api.Controllers
{
    public class ContactTypeController : BaseController<ContactType>
    {
        ...
        public override IQueryable<ContactType> Get()
        {
        ...
        public override SingleResult<ContactType> Get([FromODataUri] Guid key)
        {
            return SingleResult.Create(Context.Set<ContactType>().Where(e => e.Id == key));
        }

        [HttpPost]
        //[Auth(AuthActionTypes.Create, AuthRoles.Administrator)]
        public override async Task<IHttpActionResult> Post(ContactType entity)
        {
            // TODO: Error handling
        ...
        public override async Task<IHttpActionResult> Put([FromODataUri] Guid key, ContactType entity)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
